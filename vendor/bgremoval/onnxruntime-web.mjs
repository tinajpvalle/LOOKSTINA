...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},bp=(e,t)=>new Eo(e,t)}),zo,Ei,Ao,Oo,Ro,Bo,De,vp,xp,gt=q(()=>{"use strict";te(),se(),be(),ue(),zo=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Ei=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Ao=(e,t)=>O.sortBasedOnPerm(e,Ei(e.length,t)),Oo=(e,t,i,r)=>{let n=`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
    var a: ${i.type.indices};`;for(let o=0;o<t;++o)n+=`a[${e[o]}]=i[${o}];`;return n+="return a;}"},Ro=(e,t)=>{let i=[],r=[];for(let n=0;n<e.length;++n)e[n]!==1&&i.push(e[n]),e[t[n]]!==1&&r.push(t[n]);return{newShape:i,newPerm:r}},Bo=(e,t)=>{let i=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<i)return!1;i=e[r]}return!0},De=(e,t)=>{let i=e.dataType,r=e.dims.length,n=Ei(r,t),o=Ao(e.dims,n),s=e.dims,l=o,d=r<2||Bo(n,e.dims),c;if(d)return c=_=>{let b=N("input",i,s,4),S=K("output",i,l,4);return`
  ${_.registerUniform("output_size","u32").declareVariables(b,S)}
  ${_.mainStart()}
    ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let _=O.size(o);return{outputs:[{dims:o,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64/4)},programUniforms:[{type:12,data:Math.ceil(_/4)}]}},getShaderSource:c};let{newShape:g,newPerm:m}=Ro(e.dims,n),y=O.areEqual(m,[2,3,1]),w=O.areEqual(m,[3,1,2]);if(g.length===2||y||w){s=y?[g[0],g[1]*g[2]]:w?[g[0]*g[1],g[2]]:g,l=[s[1],s[0]];let _=16;return c=b=>{let S=N("a",i,s.length),v=K("output",i,l.length);return`
    ...
    ${S.setByOffset("global_idx",b.getByIndices("aIndices"))}
  }`},{name:"Transpose",shaderCache:{hint:`${t}`,inputDependencies:["rank"]},getRunData:()=>{let _=O.size(o);return{outputs:[{dims:o,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...Z(s,l)]}},getShaderSource:c}},vp=(e,t)=>{zo(e.inputs,t.perm),e.compute(De(e.inputs[0],t.perm))},xp=e=>ge({perm:e.perm})}),No,Mo,Do,Po,Uo,Wo,qo,Vo,Lo,Go,Ve,Sp,kp,Tp,Cp,Ip,Ep,zp,Ap,Op,Rp,py=q(()=>{"use strict";te(),se(),ue(),Da(),gt(),No={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},Mo={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},Do={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},Po={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},Uo=(e,t)=>{let i=[];for(let r=t-e;r<t;++r)i.push(r);return i},Wo=(e,t)=>{let i=[],r=e.length;for(let o=0;o<r;o++)t.indexOf(o)===-1&&i.push(e[o]);let n=t.map(o=>e[o]);return[i,n]},qo=(e,t)=>{let i=e.length+t.length,r=[],n=0;for(let o=0;o<i;o++)t.indexOf(o)===-1?r.push(e[n++]):r.push(1);return r},Vo=(e,t)=>{for(let i=0;i<e.length;++i)if(e[e.length-i-1]!==t-1-i)return!1;return!0},Lo=(e,t)=>{let i=[];if(!Vo(e,t)){for(let r=0;r<t;++r)e.indexOf(r)===-1&&i.push(r);e.forEach(r=>i.push(r))}return i},Go=(e,t,i,r,n,o,s)=>{let l=i[0].dims,d=O.size(o),c=O.size(s),g=N("_A",i[0].dataType,l),m=K("output",n,o),y=64;d===1&&(y=256);let w=`
       ...
       `,_=b=>`
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${m.setByOffset("outputIndex",`${r==="mean"?`${m.type.storage}(bestValue / f32(uniforms.reduceSize))`:`${m.type.storage}(${Po[r]})`}`)};
         }
        }`;return{name:e,shaderCache:{hint:`${t};${y}`,inputDependencies:["type"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:{x:d},programUniforms:[{type:12,data:c}]})}},Ve=(e,t,i,r)=>{let n=e.inputs.length===1?i:ca(e.inputs,i),o=n.axes;o.length===0&&!n.noopWithEmptyAxes&&(o=e.inputs[0].dims.map((w,_)=>_));let s=O.normalizeAxes(o,e.inputs[0].dims.length),l=s,d=e.inputs[0],c=Lo(l,e.inputs[0].dims.length);c.length>0&&(d=e.compute(De(e.inputs[0],c),{inputs:[0],outputs:[-1]})[0],l=Uo(l.length,d.dims.length));let[g,m]=Wo(d.dims,l),y=g;n.keepDims&&(y=qo(g,s)),e.compute(Go(t,n.cacheKey,[d],r,e.inputs[0].dataType,y,m),{inputs:[d]})},Sp=(e,t)=>{Ve(e,"ReduceMeanShared",t,"mean")},kp=(e,t)=>{Ve(e,"ReduceL1Shared",t,"l1")},Tp=(e,t)=>{Ve(e,"ReduceL2Shared",t,"l2")},Cp=(e,t)=>{Ve(e,"ReduceLogSumExpShared",t,"logSumExp")},Ip=(e,t)=>{Ve(e,"ReduceMaxShared",t,"max")},Ep=(e,t)=>{Ve(e,"ReduceMinShared",t,"min")},zp=(e,t)=>{Ve(e,"ReduceProdShared",t,"prod")},Ap=(e,t)=>{Ve(e,"ReduceSumShared",t,"sum")},Op=(e,t)=>{Ve(e,"ReduceSumSquareShared",t,"sumSquare")},Rp=(e,t)=>{Ve(e,"ReduceLogSumShared",t,"logSum")}}),Le,Ho,qr,ca,Ge,Fo,jo,Ko,Qo,Zo,Xo,Yo,Jo,eu,tu,He,Bp,Np,Mp,Dp,Pp,Up,Wp,qp,Vp,Lp,Da=q(()=>{"use strict";te(),se(),be(),ue(),py(),Le=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Ho=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],qr=(e,t,i,r,n,o,s=!1,l=!1)=>{let d=[],c=i[0].dims,g=c.length,m=O.normalizeAxes(n,g),y=!l&&m.length===0;c.forEach((b,S)=>{y||m.indexOf(S)>=0?s&&d.push(1):d.push(b)});let w=d.length,_=O.size(d);return{name:e,shaderCache:t,getShaderSource:b=>{let S=[],v=N("_A",i[0].dataType,g),$=K("output",o,w),k=r(v,$,m),C=k[2];for(let I=0,E=0;I<g;I++)y||m.indexOf(I)>=0?(s&&E++,C=`for(var j${I}: u32 = 0; j${I} < ${c[I]}; j${I}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return e.compute({name:"AttentionPrepare",shaderCache:{inputDependencies:["type","type","type"]},getRunData:()=>({outputs:[{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0}],dispatchGroup:l,programUniforms:c}),getShaderSource:g},{inputs:d,outputs:[-1,-1,-1]})},Fp=(e,t)=>{let i=ru(e.inputs,t),[r,n,o]=su(e,i);return sr(e,r,n,o,e.inputs[4],void 0,void 0,void 0,e.inputs[5],i)}}),ou,uu,lu,jp,hy=q(()=>{"use strict";Ke(),te(),se(),be(),ue(),ou=(e,t)=>{if(!e||e.length!==5)throw new Error("BatchNormalization requires 5 inputs");let i=(r,n,o)=>{let s=n.length;if(s!==r.length)throw new Error(`${o}: num dimensions != ${s}`);n.forEach((l,d)=>{if(l!==r[d])throw new Error(`${o}: dim[${d}] do not match`)})};if(e[0].dims.length>1){let r=t.format==="NHWC"?t.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,t.spatial?2:void 0);i(e[1].dims,r,"Invalid input scale"),i(e[2].dims,r,"Invalid input B"),i(e[3].dims,r,"Invalid input mean"),i(e[4].dims,r,"Invalid input var")}else i(e[1].dims,[1],"Invalid input scale"),i(e[2].dims,[1],"Invalid input B"),i(e[3].dims,[1],"Invalid input mean"),i(e[4].dims,[1],"Invalid input var")},uu=(e,t)=>{let{epsilon:i,spatial:r,format:n}=t,o=e[0].dims,s=r?$e(o[o.length-1]):1,l=n==="NHWC"&&o.length>1?s:1,d=O.size(o)/s,c=r,g=c?o.length:o,m=N("x",e[0].dataType,e[0].dims,s),y=N("scale",e[1].dataType,e[1].dims,l),w=N("bias",e[2].dataType,e[2].dims,l),_=N("inputMean",e[3].dataType,e[3].dims,l),b=N("inputVar",e[4].dataType,e[4].dims,l),S=K("y",e[0].dataType,g,s),v=()=>{let k="";if(r)k=`let cOffset = ${o.length===1?"0u":n==="NHWC"?`outputIndices[${o.length-1}] / ${s}`:"outputIndices[1]"};`;else if(n==="NCHW")k=`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${s}`,inputDependencies:c?["rank","type","type","type","type"]:void 0},getShaderSource:$,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c?[{type:12,data:d},...Z(o)]:[{type:12,data:d}]})}},lu=e=>ge(e),jp=(e,t)=>{let{inputs:i,outputCount:r}=e,n=lu({...t,outputCount:r});if(we.webgpu.validateInputContent&&ou(i,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(uu(i,n))}}),du,pu,Kp,fy=q(()=>{"use strict";se(),ue(),du=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},pu=e=>{let t=e[0].dims,i=e[0].dims[2],r=O.size(t)/4,n=e[0].dataType,o=N("input",n,t,4),s=N("bias",n,[i],4),l=N("residual",n,t,4),d=K("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:c=>`
  ...
  }`}},Kp=e=>{du(e.inputs),e.compute(pu(e.inputs))}}),cu,fe,Qp,Zp,Xp,Yp,Jp,ec,tc,rc,ic,hu,ac,nc,sc,oc,ir,uc,Nr,lc,dc,pc,cc,hc,fc,mc,gc,yc,_c,wc,$c,bc,vc,xc,Sc,Ai,kc,fa,ma,Tc,Cc,Ic,fu,mu,Ec,Ua=q(()=>{"use strict";te(),se(),be(),ue(),cu=(e,t,i,r,n,o,s)=>{let l=Math.ceil(t/4),d="";typeof n=="string"?d=`${n}(a)`:d=n("a");let c=N("inputData",i,[l],4),g=K("outputData",r,[l],4),m=[{name:"vec_size",type:"u32"}];return s&&m.push(...s),`
  ...
  }`},fe=(e,t,i,r,n,o=e.dataType,s,l)=>{let d=[{type:12,data:Math.ceil(O.size(e.dims)/4)}];return s&&d.push(...s),{name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:c=>cu(c,O.size(e.dims),e.dataType,o,i,r,l),getRunData:c=>({outputs:[{dims:e.dims,dataType:o}],dispatchGroup:{x:Math.ceil(O.size(c[0].dims)/64/4)},programUniforms:d})}},Qp=e=>{e.compute(fe(e.inputs[0],"Abs","abs"))},Zp=e=>{e.compute(fe(e.inputs[0],"Acos","acos"))},Xp=e=>{e.compute(fe(e.inputs[0],"Acosh","acosh"))},Yp=e=>{e.compute(fe(e.inputs[0],"Asin","asin"))},Jp=e=>{e.compute(fe(e.inputs[0],"Asinh","asinh"))},ec=e=>{e.compute(fe(e.inputs[0],"Atan","atan"))},tc=e=>{e.compute(fe(e.inputs[0],"Atanh","atanh"))},rc=e=>ge(e),ic=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(fe(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},hu=e=>{let t,i,r=e.length>=2&&e[1].data!==0,n=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,i=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,i=n?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return ge({min:t,max:i})},ac=(e,t)=>{let i=t||hu(e.inputs),r=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Clip",n=>`clamp(${n}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},nc=e=>{e.compute(fe(e.inputs[0],"Ceil","ceil"))},sc=e=>{e.compute(fe(e.inputs[0],"Cos","cos"))},oc=e=>{e.compute(fe(e.inputs[0],"Cosh","cosh"))},ir=e=>ge(e),uc=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,lc=e=>{let t=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,Nr(t)))},dc=e=>{e.compute(fe(e.inputs[0],"Exp","exp"))},pc=e=>{e.compute(fe(e.inputs[0],"Floor","floor"))},cc=e=>{let t=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,Nr(t)))},hc=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},fc=e=>{e.compute(fe(e.inputs[0],"Not",t=>`!${t}`))},mc=e=>{e.compute(fe(e.inputs[0],"Neg",t=>`-${t}`))},gc=e=>{e.compute(fe(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},yc=e=>{let t=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},_c=e=>{e.compute(fe(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},wc=e=>ge(e),$c=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"HardSigmoid",r=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${r} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},bc=e=>{e.compute(fe(e.inputs[0],"Sin","sin"))},vc=e=>{e.compute(fe(e.inputs[0],"Sinh","sinh"))},xc=e=>{e.compute(fe(e.inputs[0],"Sqrt","sqrt"))},Sc=e=>{e.compute(fe(e.inputs[0],"Tan","tan"))},Ai=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,kc=e=>{e.compute(fe(e.inputs[0],"Tanh",Ai))},fa=(e="f32")=>`
...
`,ma=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Tc=e=>{let t=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"FastGelu",ma,fa(t),void 0,e.inputs[0].dataType))},Cc=(e,t)=>{let i=ze(e.inputs[0].dataType);return e.compute(fe(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${i}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},Ic=e=>{e.compute(fe(e.inputs[0],"Log","log"))},fu=(e,t)=>`
...
`,mu=e=>`quick_gelu_impl(${e})`,Ec=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(fe(e.inputs[0],"QuickGelu",mu,fu(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),gu,yu,zc,my=q(()=>{"use strict";se(),ue(),Ua(),gu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},yu=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=N("input",e[0].dataType,e[0].dims,4),r=N("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),o=O.size(t)/4,s=Te(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:l=>`
  ...
  ${l.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${v}
      }`},wu=(e,t,i,r,n,o,s=i.dataType)=>{let l=i.dims.map(b=>Number(b)??1),d=r.dims.map(b=>Number(b)??1),c=!O.areEqual(l,d),g=l,m=O.size(l),y=!1,w=!1,_=[c];if(c){let b=Pt.calcShape(l,d,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");g=b.slice(),m=O.size(g);let S=O.size(l)===1,v=O.size(d)===1,$=l.length>0&&l[l.length-1]%4===0,k=d.length>0&&d[d.length-1]%4===0;_.push(S),_.push(v),_.push($),_.push(k);let C=1;for(let I=1;I<g.length;I++){let E=l[l.length-I],A=d[d.length-I];if(E===A)C*=E;else break}C%4===0?(w=!0,y=!0):(S||v||$||k)&&(y=!0)}else y=!0;return _.push(y),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>_u(b,l,d,g,y,c,w,n,i.dataType,r.dataType,s,o),getRunData:()=>({outputs:[{dims:g,dataType:s}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:[{type:12,data:Math.ceil(O.size(g)/4)},...Z(l,d,g)]})}},Fe=(e,t,i,r,n,o)=>{e.compute(wu(t,n??"",e.inputs[0],e.inputs[1],i,r,o))},Ac=e=>{Fe(e,"Add",(t,i)=>`${t}+${i}`)},Oc=e=>{Fe(e,"Div",(t,i)=>`${t}/${i}`)},Rc=e=>{Fe(e,"Equal",{scalar:(t,i)=>`u32(${t}==${i})`,vector:(t,i)=>`vec4<u32>(${t}==${i})`},void 0,void 0,9)},Bc=e=>{Fe(e,"Mul",(t,i)=>`${t}*${i}`)},Nc=e=>{let t=N("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Fe(e,"Pow",{scalar:(i,r)=>`pow_custom(${i},${r})`,vector:(i,r)=>`pow_vector_custom(${i},${r})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Mc=e=>{Fe(e,"Sub",(t,i)=>`${t}-${i}`)},Dc=e=>{Fe(e,"Greater",{scalar:(t,i)=>`u32(${t}>${i})`,vector:(t,i)=>`vec4<u32>(${t}>${i})`},void 0,void 0,9)},Pc=e=>{Fe(e,"Less",{scalar:(t,i)=>`u32(${t}<${i})`,vector:(t,i)=>`vec4<u32>(${t}<${i})`},void 0,void 0,9)},Uc=e=>{Fe(e,"GreaterOrEqual",{scalar:(t,i)=>`u32(${t}>=${i})`,vector:(t,i)=>`vec4<u32>(${t}>=${i})`},void 0,void 0,9)},Wc=e=>{Fe(e,"LessOrEqual",{scalar:(t,i)=>`u32(${t}<=${i})`,vector:(t,i)=>`vec4<u32>(${t}<=${i})`},void 0,void 0,9)}}),$u,bu,vu,xu,qc,Vc,yy=q(()=>{"use strict";te(),se(),be(),ue(),$u=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let i=0,r=e[i],n=r.dataType,o=r.dims.length;e.forEach((s,l)=>{if(l!==i){if(s.dataType!==n)throw new Error("input tensors should be one type");if(s.dims.length!==o)throw new Error("input tensors should have the same shape");s.dims.forEach((d,c)=>{if(c!==t&&d!==r.dims[c])throw new Error("non concat dimensions must match")})}})},bu=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,vu=(e,t)=>{let i=e.length,r=[];for(let n=0;n<i;++n){let o=t.setByOffset("global_idx",e[n].getByIndices("indices"));i===1?r.push(o):n===0?r.push(`if (inputIndex == ${n}u) { ${o} }`):n===i-1?r.push(`else { ${o} }`):r.push(`else if (inputIndex == ${n}) { ${o} }`)}return r.join(`
`)},xu=(e,t,i,r)=>{let n=O.size(i),o=new Array(e.length),s=new Array(e.length),l=0,d=[],c=[],g=[{type:12,data:n}];for(let b=0;b<e.length;++b)l+=e[b].dims[t],o[b]=l,c.push(e[b].dims.length),s[b]=N(`input${b}`,r,c[b]),d.push("rank"),g.push({type:12,data:o[b]});for(let b=0;b<e.length;++b)g.push(...Z(e[b].dims));g.push(...Z(i));let m=K("output",r,i.length),y=m.indicesGet("indices",t),w=Array.from(Array(o.length).keys()).map(b=>`uniforms.sizeInConcatAxis${b}`).join(","),_=b=>`
  ...
  ${b.mainStart()}
    ...
    ${vu(s,m)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:g}),getShaderSource:_}},qc=(e,t)=>{let i=e.inputs,r=i[0].dims,n=O.normalizeAxis(t.axis,r.length);$u(i,n);let o=r.slice();o[n]=i.reduce((l,d)=>l+(d.dims.length>n?d.dims[n]:0),0);let s=i.filter(l=>O.size(l.dims)>0);e.compute(xu(s,n,o,i[0].dataType),{inputs:s})},Vc=e=>ge({axis:e.axis})}),Tt,Ct,It,Wa,zt=q(()=>{"use strict";te(),se(),Tt=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Ct=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},It=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Wa=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[i,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=e?.activation_params||[_p,wp];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=e?.activation_params||[.01];return{activation:t,alpha:i}}return{activation:t}}}),Ce,Lc,qa=q(()=>{"use strict";Ce=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Lc=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `}),Gc,_y=q(()=>{"use strict";Gc=e=>`
...
`}return de};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${m};${y};${w};${n}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:o?o(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:$}),getShaderSource:k}}}),Su,ku,ga,Oi,Tu,ya,Cu,Vr,Ga=q(()=>{"use strict";te(),se(),ue(),zt(),La(),qa(),Su=(e,t)=>e?`
...
`},Cu=(e,t,i,r,n=!1)=>{let[o,s,l,d]=r,c=Te(r[0].type.tensor);return`
  ...
  ${_.mainStart()}
    ...
    ${pe}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${g}${y}${m}${c===1}`,inputDependencies:b},getRunData:()=>({dispatchGroup:{x:_[0],y:_[1],z:_[2]},outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],programUniforms:I}),getShaderSource:E}}}),Mu,Du,Pu,Mi,Xc,Uu,Di,Wu,Yc,Sy=q(()=>{"use strict";xy(),zt(),gt(),Mu=(e,t,i,r,n,o)=>(e-1)*t+i+(r-1)*n+1-o,Du=(e,t,i,r,n)=>{let o=Math.floor(e/2);t==="SAME_UPPER"?(i[r]=o,i[n]=e-o):t==="SAME_LOWER"&&(i[r]=e-o,i[n]=o)},Pu=(e,t,i,r,n,o,s,l,d,c)=>{let g=e.length-2,m=c.length===0;d.length<g&&d.push(...Array(g-d.length).fill(0));let y=e[0],w=t[l?3:1]*n;for(let _=0,b=e.length-g-(l?1:0);_<g;++_,++b){let S=e[b],v=m?S*s[_]:c[_],$=Mu(S,s[_],o[_],t[b],i[_],v);Du($,r,o,_,_+g),m&&c.push(s[_]*(S-1)+d[_]+(t[b]-1)*i[_]+1-o[_]-o[_+g])}c.splice(0,0,y),c.splice(l?3:1,0,w)},Mi=(e,t)=>{let i=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((m,y)=>m*y,1)===0){i.length=0;for(let m=2;m<t[1].dims.length;++m)i.push(t[1].dims[m])}let r=e.format==="NHWC";i.splice(0,0,t[1].dims[0]),i.splice(r?3:1,0,t[1].dims[1]);let n=e.pads.slice(),o=e.outputShape.slice(),s=e.outputPadding.slice(),l=t[0].dims,d=e.dilations.slice();if(d.reduce((m,y)=>m+y,0)===0){let m=t[0].dims.length-2;d=new Array(m).fill(1)}let c=e.strides.slice();if(c.reduce((m,y)=>m+y,0)===0){let m=t[0].dims.length-2;c=new Array(m).fill(1)}Pu(l,i,d,e.autoPad,e.group,n,c,r,s,o);let g=Object.assign({},e);return Object.assign(g,{kernelShape:i,pads:n,outputPadding:s,outputShape:o,dilations:d,strides:c}),g},Xc=e=>{let t=Wa(e),i=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,o=e.group,s=e.kernelShape,l=e.pads,d=e.strides,c=e.wIsConst(),g=e.outputPadding,m=e.outputShape;return{autoPad:r,format:i,dilations:n,group:o,kernelShape:s,outputPadding:g,outputShape:m,pads:l,strides:d,wIsConst:c,...t,cacheKey:`${e.format};${t.activation};`}},Uu=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(i!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.reduce((s,l)=>s+l,0)>0&&t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.reduce((s,l)=>s+l,0)>0&&t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.reduce((s,l)=>s+l,0)>0&&t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.outputPadding.length!==o&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${o}D`);if(t.kernelShape.reduce((s,l)=>s+l,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Di=(e,t,i,r)=>{let n=e.kernelCustomData.wT??e.compute(De(t[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=n);let o=[t[0],n];t.length===3&&o.push(t[2]),e.compute(Zc(o,i,r),{inputs:o})},Wu=(e,t)=>{let i=t.format==="NHWC",r=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let n=t.kernelShape;(n.length===0||n[0]===0)&&(n=[e.inputs[1].dims[2]]);let o=t.dilations;(o.length===0||o[0]===0)&&(o=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let l=t.pads;l.length===0&&(l=[0,0]),l=[0,l[0],0,l[1]],s=[1].concat(s),o=[1].concat(o),n=[1].concat(n);let d=t.outputPadding;d=[0].concat(d);let c=Mi({...t,pads:l,strides:s,dilations:o,kernelShape:n,outputPadding:d},r);Di(e,r,c,g=>i?[g[0],g[2],g[3]]:[g[0],g[1],g[3]])},Yc=(e,t)=>{if(Uu(e.inputs,t),e.inputs[0].dims.length===3)Wu(e,t);else{let i=Mi(t,e.inputs);Di(e,e.inputs,i)}}}),qu,Jc,eh,ky=q(()=>{"use strict";te(),se(),be(),ue(),qu=(e,t,i,r)=>{let n=O.size(t),o=t.length,s=N("input",e,o),l=K("output",e,o),d=i.dataType===6?i.getInt32Array()[0]:Number(i.getBigInt64Array()[0]),c=O.normalizeAxis(d,o),g=m=>{let y=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,w=Q("uniforms.input_shape","uniforms.axis",o),_=r.reverse?y+(r.exclusive?" + 1":""):"0",b=r.reverse?w:y+(r.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:12,data:n},{type:12,data:c},...Z(t,t)]}),getShaderSource:g}},Jc=(e,t)=>{let i=e.inputs[0].dims,r=e.inputs[0].dataType,n=e.inputs[1];e.compute(qu(r,i,n,t),{inputs:[0]})},eh=e=>{let t=e.exclusive===1,i=e.reverse===1;return ge({exclusive:t,reverse:i})}}),Vu,Lu,Gu,th,rh,Ty=q(()=>{"use strict";te(),se(),be(),ue(),Vu=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Lu=(e,t,i,r)=>{let n=[];n.push(`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
    var a: ${i.type.indices};`);for(let o=0;o<t;++o)n.push(i.indicesSet("a",e[o],`i[${o}]`));return n.push("return a;}"),n.join(`
`)},Gu=(e,t)=>{let i,r,n,o,s,l,d=t.format==="NHWC",c=t.blocksize,g=t.mode==="DCR";d?([i,r,n,o]=e.dims,s=g?[i,r,n,c,c,o/c**2]:[i,r,n,o/c**2,c,c],l=g?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([i,r,n,o]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],s=g?[i,c,c,o/c**2,r,n]:[i,o/c**2,c,c,r,n],l=g?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let m=e.reshape(s),y=m.dims.length,w=e.dataType,_=N("a",w,y),b=K("output",w,y),S=v=>`
...
`)};
    ...
    ${_}`},g=[{type:12,data:d},...Z(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${l}`,inputDependencies:["rank"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:g})}},nh=e=>{Zu(e.inputs),e.compute(Yu(e.inputs),{inputs:[0]})}}),Ju,sh,Ey=q(()=>{"use strict";te(),se(),ue(),Ua(),Ju=e=>{let t=e[0].dataType,i=O.size(e[0].dims),r=O.size(e[1].dims),n=r%4===0,o=s=>{let l=N("x",t,[1],4),d=N("bias",t,[1],4),c=K("y",t,[1],4),g=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],m=w=>`
  ...
  ${y.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((w,_)=>_!==1).map(w=>w.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(w,_)=>"rank")},getRunData:()=>({outputs:[{dims:l,dataType:c}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:m}),getShaderSource:y}},ph=(e,t)=>{let i=e.inputs;il(i,t),e.compute(al(e.inputs,t))},ch=e=>ge({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),nl,sl,hh,fh,Ry=q(()=>{"use strict";te(),se(),be(),ue(),nl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},sl=(e,t)=>{let i=e[0].dims,r=e[0].dataType,n=i.length,o=e[1].dims,s=e[1].dataType,l=O.normalizeAxis(t.axis,n),d=i[l],c=o.slice(0),g=O.size(c),m=N("input",r,n),y=N("indicesInput",s,o.length),w=K("output",r,c.length),_=[{type:12,data:g},{type:6,data:d},{type:12,data:l}];return _.push(...Z(i,o,c)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:_}),getShaderSource:b=>`
  ...
  }`};return m?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:c*g},programUniforms:w}),getShaderSource:S}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:w}),getShaderSource:b}},mh=e=>{let t=e.transA,i=e.transB,r=e.alpha,n=e.beta;return{transA:t,transB:i,alpha:r,beta:n,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},gh=(e,t)=>{ol(e.inputs),e.compute(ul(e.inputs,t))}}),Ye,nt,wt,$t,ll,dl,pl,cl,hl,fl,ml,gl,yh,_h,Ny=q(()=>{"use strict";te(),se(),be(),ue(),[Ye,nt,wt,$t]=[0,1,2,3],ll=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},dl=`
...
`,ml=(e,t,i)=>(()=>{switch(i.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:l,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c}),getShaderSource:g},{inputs:[t,i],outputs:[-1]})[0]},ar=(e,t,i,r,n,o,s,l)=>{let d=o;if(s&&O.size(s.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return d=_l(e,o,s,t,r,i*n,l),d=d.reshape([t,r,i,n]),i===1||r===1?d:e.compute(De(d,qi.perm),{inputs:[d],outputs:[-1]})[0]}else return o.dims.length===3&&(d=o.reshape([t,r,i,n])),i===1||r===1?d:e.compute(De(d,qi.perm),{inputs:[d],outputs:[-1]})[0]},$h=(e,t)=>{let i=yl(e.inputs,t),r=e.inputs[0],n=Ae(e.inputs,1),o=Ae(e.inputs,2),s=Ae(e.inputs,3),l=Ae(e.inputs,4),d=Ae(e.inputs,5),c=Ae(e.inputs,6),g=Ae(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if(n?.dims.length===5)throw new Error("Packed KV is not implemented");let m=n&&o&&n.dims.length===4&&o.dims.length===4,y=ar(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r,s,0);if(m)return sr(e,y,n,o,l,void 0,c,g,d,i);if(!n||!o)throw new Error("key and value must be provided");let w=ar(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.headSize,n,s,i.hiddenSize),_=ar(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.vHeadSize,o,s,2*i.hiddenSize);sr(e,y,w,_,l,void 0,c,g,d,i)}}),wl,$l,bl,vl,$a,vh,xh,Sh=q(()=>{"use strict";te(),se(),be(),ue(),wl=e=>{if(!e||e.length<1)throw new Error("too few inputs")},$l=(e,t)=>{let i=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>i.push(Number(n))),r=i.length),ge({numOutputs:r,axis:t.axis,splitSizes:i})},bl=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
}`,vl=e=>{let t=e.length,i=[];for(let r=0;r<t;++r){let n=e[r].setByIndices("indices","input[global_idx]");t===1?i.push(n):r===0?i.push(`if (output_number == ${r}u) { ${n} }`):r===t-1?i.push(`else { ${n} }`):i.push(`else if (output_number == ${r}) { ${n} }`)}return`
...
`)}
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${d}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:g}),getShaderSource:S},{inputs:[t[0],b]})},Th=(e,t)=>{t.format==="NHWC"?Tl(e,e.inputs,t):kl(e,e.inputs,t)}}),Cl,Il,Ch,Py=q(()=>{"use strict";te(),se(),ue(),Cl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Il=(e,t,i)=>{let r=t.simplified,n=e[0].dims,o=e[1],s=!r&&e[2],l=n,d=O.normalizeAxis(t.axis,n.length),c=O.sizeToDimension(n,d),g=O.sizeFromDimension(n,d),m=O.size(o.dims),y=s?O.size(s.dims):0;if(m!==g||s&&y!==g)throw new Error(`Size of X.shape()[axis:] == ${g}.
  ...
  ${I.mainStart()}
    ...
    ${$?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${m};${y};${S};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:w,dataType:g}],dispatchGroup:{x:C},programUniforms:I}),getShaderSource:V}},Eh=(e,t)=>{zl(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Ol(e.inputs,t)):e.compute(Al(e.inputs,t))},zh=e=>ge(e)}),Rl,Bl,Nl,Ml,Dl,Pl,Ul,Wl,Ah,qy=q(()=>{"use strict";te(),se(),ue(),Rl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Bl=(e,t,i)=>{let r="";for(let n=t-1;n>=0;--n)r+=`
      ...
      `},Nl=(e,t,i)=>{let r="";for(let n=t-1;n>=0;--n)r+=`
          ...
          `},Dl=(e,t,i)=>{let r="";for(let n=t-1;n>=0;--n)r+=`
            ...
            `;return`
              ...
              ${r}
              value = x[offset];
          `},Pl=(e,t,i)=>{switch(i.mode){case 0:return Bl(e,t,i.pads.length);case 1:return Nl(e,t,i.pads.length);case 2:return Ml(e,t,i.pads.length);case 3:return Dl(e,t,i.pads.length);default:throw new Error("Invalid mode")}},Ul=(e,t)=>{let i=O.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,n=O.size(i),o=[{type:12,data:n},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&o.push({type:s?e[2].dataType:1,data:t.value}),o.push(...Z(e[0].dims,i));let l=["rank"],d=c=>{let g=K("output",e[0].dataType,i.length),m=N("x",e[0].dataType,r.length),y=m.type.value,w=Pl(g,r.length,t),_=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&_.push({name:"constant_value",type:s?y:"f32"}),`
    ...
    `,l="",d=N("x",t.dataType,t.dims.length),c=["rank"],[g,m,y,w,_]=Hi(o,n);return g.push(...Z(t.dims,o)),{name:e,shaderCache:{hint:`${r.cacheKey};${y};${w};${_}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(o)/64)},programUniforms:g}),getShaderSource:b=>Fi(b,d,t.dims.length,o.length,n,s,l,t.dataType===10?-65504:-1e5,m,y,w,_)}},Mh=(e,t)=>{Xt(e.inputs),e.compute(Xi("MaxPool",e.inputs[0],!1,t))},Dh=e=>{let t=e.storage_order,i=e.dilations,r=Ki(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:i,...r,cacheKey:""};return{...n,cacheKey:Vl(n)}},Ph=e=>{let t=e.format;return{format:t,...Zi,cacheKey:t}},Uh=(e,t)=>{Xt(e.inputs),e.compute(Xi("GlobalMaxPool",e.inputs[0],!0,t))}}),Ll,Gl,Wh,qh,Ly=q(()=>{"use strict";te(),se(),be(),ue(),Ll=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,r)=>i===e[2].dims[r]).reduce((i,r)=>i&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,o)=>o===t.axis||n===e[0].dims[o]).reduce((n,o)=>n&&o,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/r)||t.blockSize>Math.ceil(i/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Gl=(e,t)=>{let i=O.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,n=r===3,o=e[0].dims,s=e[1].dataType,l=O.size(o),d=r===3||r===2,c=d?[Math.ceil(O.size(e[0].dims)/4)]:e[0].dims,g=e[1].dims,m=e.length>2?e[2]:void 0,y=m?d?[Math.ceil(O.size(m.dims)/4)]:m.dims:void 0,w=g.length===0||g.length===1&&g[0]===1,_=w===!1&&g.length===1,b=$e(l),S=w&&(!d||b===4),v=S?b:1,$=S&&!d?b:1,k=N("input",d?12:r,c.length,$),C=N("scale",s,g.length),I=m?N("zero_point",d?12:r,y.length):void 0,E=K("output",s,o.length,v),A=[k,C];I&&A.push(I);let D=[c,g];m&&D.push(y);let V=[{type:12,data:l/v},{type:12,data:i},{type:12,data:t.blockSize},...Z(...D,o)],H=X=>{let ee=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:I?["rank","rank","rank"]:["rank","rank"]},getShaderSource:H,getRunData:()=>({outputs:[{dims:o,dataType:s}],dispatchGroup:{x:Math.ceil(l/v/64),y:1,z:1},programUniforms:V})}},Wh=(e,t)=>{Ll(e.inputs,t),e.compute(Gl(e.inputs,t))},qh=e=>ge({axis:e.axis,blockSize:e.blockSize})}),Hl,Fl,Vh,Gy=q(()=>{"use strict";Ke(),te(),ue(),Hl=(e,t,i)=>{let r=e===t,n=e<t&&i<0,o=e>t&&i>0;if(r||n||o)throw new Error("Range these inputs' contents are invalid.")},Fl=(e,t,i,r)=>{let n=Math.abs(Math.ceil((t-e)/i)),o=[n],s=n,l=[{type:12,data:s},{type:r,data:e},{type:r,data:i},...Z(o)],d=c=>{let g=K("output",r,o.length),m=g.type.value,y=[{name:"outputSize",type:"u32"},{name:"start",type:m},{name:"delta",type:m}];return`
        ${c.registerUniforms(y).declareVariables(g)}
        ${c.mainStart()}
        ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${m}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:d,getRunData:()=>({outputs:[{dims:o,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:l})}},Vh=e=>{let t=0,i=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),we.webgpu.validateInputContent&&Hl(t,i,r),e.compute(Fl(t,i,r,e.inputs[0].dataType),{inputs:[]})}}),jl,Kl,Lh,Gh,Hy=q(()=>{"use strict";te(),se(),be(),ue(),jl=(e,t,i,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,o=`;
              ...
              ${n}bitcast<${r}>(oldValue) + (${i})${o}`;case"max":return r==="i32"||r==="u32"?`atomicMax(&${t}, bitcast<${r}>(${i}));`:`
                ${n}max(bitcast<f32>(oldValue), (${i}))${o}`;case"min":return r==="i32"||r==="u32"?`atomicMin(&${t}, bitcast<${r}>(${i}));`:`${n}min(bitcast<${r}>(oldValue), (${i}))${o}`;case"mul":return`${n}(bitcast<${r}>(oldValue) * (${i}))${o}`;default:throw new Error(`Reduction ${e} is not supported.`)}},Kl=(e,t)=>{let i=e[0].dims,r=e[1].dims,n=i,o=1,s=Math.ceil(O.size(r)/o),l=r[r.length-1],d=O.sizeFromDimension(i,l),c=[{type:12,data:s},{type:12,data:l},{type:12,data:d},...Z(e[1].dims,e[2].dims,n)],g=m=>{let y=N("indices",e[1].dataType,e[1].dims.length),w=N("updates",e[2].dataType,e[2].dims.length,o),_=t.reduction!=="none"&&t.reduction!==""?$p("output",e[0].dataType,n.length):K("output",e[0].dataType,n.length,o);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${jl(t.reduction,"output[data_offset + i]","value",_.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:c}),getShaderSource:g}},Lh=e=>ge({reduction:e.reduction}),Gh=(e,t)=>{e.compute(Kl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Ql,Zl,Xl,Yi,Yl,Jl,ed,td,rd,id,ad,nd,Ji,sd,od,ud,ld,dd,Hh,Fh,Fy=q(()=>{"use strict";te(),se(),be(),ue(),Ql=(e,t)=>{if(e.every(i=>i>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},Zl=(e,t,i)=>{t.every(n=>n>=0&&n<i||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let r=new Array(i).fill(1);return t.forEach((n,o)=>r[n]=e[o]),r},Xl=(e,t,i,r,n,o)=>{let[s,l,d]=i>10?[1,2,3]:[-1,e.length>1?1:-1,-1],c=e[0].dims.length;if(s>0&&e.length>s&&e[s].dims.length>0)e[s].getFloat32Array().forEach(g=>o.push(g));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(l>0&&e.length>l&&e[l].dims.length===1&&e[l].dims[0]>0){if(e[l].getFloat32Array().forEach(g=>r.push(g)),r.length!==0&&r.length!==c&&i>=18&&r.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");Ql(r,t),t.axes.length>0&&Zl(r,t.axes,c).forEach((g,m)=>r[m]=g)}if(d>0&&e.length>d&&e[d].dims.length===1&&e[d].dims[0]>0&&(e[d].getBigInt64Array().forEach(g=>n.push(Number(g))),n.length!==0&&n.length!==c&&i>=18&&n.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(r.length!==0&&r.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==0&&n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof r<"u"&&typeof n<"u"&&r.length>0&&n.length>c)throw new Error("Resize requires only of scales or sizes to be specified")},Yi=(e,t,i,r)=>`
...
`,Yl=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`
        ...
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Jl=(e,t,i)=>`fn getNearestPixelFromOriginal(xOriginal: ${i}, isDownSample: bool) -> ${i} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",ed=(e,t,i)=>{let r=new Array(i).fill(0).concat(new Array(i).fill(1)),n=e.length===0?r:e.slice();return t.length>0?(t.forEach((o,s)=>{r[o]=n[s],r[s+i]=n[t.length+s]}),r):n},td=(e,t,i,r)=>{let n=[];if(i.length>0)if(r.length>0){if(e.forEach(o=>n.push(o)),Math.max(...r)>e.length)throw new Error("axes is out of bound");r.forEach((o,s)=>n[o]=i[s])}else i.forEach(o=>n.push(o));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((o,s)=>Math.round(o*t[s]))}return n},rd=(e,t,i)=>{let r=(()=>{switch(i.keepAspectRatioPolicy){case"not_larger":return i.axes.length>0?Math.min(...i.axes.map(o=>t[o]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return i.axes.length>0?Math.max(...i.axes.map(o=>t[o]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${i.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let n=e.slice();return i.axes.length>0?(i.axes.forEach(o=>t[o]=r),i.axes.forEach(o=>n[o]=Math.round(e[o]*t[o]))):(t.fill(r,0,t.length),n.forEach((o,s)=>n[s]=Math.round(o*t[s]))),n},id=(e,t,i,r,n)=>`
...
`:"",sd=(e,t,i,r,n)=>{let[o,s,l,d]=i.length===2?[-1,0,1,-1]:[0,2,3,1],c=e.type.value;return`
    ...
    }`},od=(e,t,i,r,n,o,s,l,d,c)=>{let g=i.length===2,m=!0,[y,w]=g?[0,1]:m?[2,3]:[1,2],_=e.type.value,b=S=>{let v=S===y?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${_} {
    ...
    `},ud=(e,t,i,r,n)=>{let[o,s,l,d,c]=i.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],g=e.type.value;return`
    ...
    }`},ld=(e,t,i,r,n,o)=>{let s=e.dims,l=ed(o,t.axes,s.length),d=td(s,r,n,t.axes),c=r.slice();r.length===0&&(c=s.map(($,k)=>$===0?1:d[k]/$),t.keepAspectRatioPolicy!=="stretch"&&(d=rd(s,c,t)));let g=K("output",e.dataType,d.length),m=N("input",e.dataType,s.length),y=O.size(d),w=s.length===d.length&&s.every(($,k)=>$===d[k]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,S=m.type.value,v=$=>`
      ${w?"":`
      ${Yl(t.coordinateTransformMode,S)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${nd(m,s)};
              ${Jl(t.nearestMode,i,S)};
              ${ad(m,g,s,d,c.length,l.length,_)};
              `;case"linear":return`
              ${id(g,s,d,c.length,l.length)};
              ${(()=>{if(s.length===2||s.length===4)return`${sd(m,g,s,_,b)}`;if(s.length===3||s.length===5)return`${ud(m,g,s,_,b)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(s.length===2||s.length===4)return`${od(m,g,s,d,c,l,t.cubicCoeffA,_,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`,E=e.compute({name:"Softmax",shaderCache:{hint:`${w};${b}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:g,dataType:d.dataType}],dispatchGroup:{x:y},programUniforms:[{type:6,data:_}]}),getShaderSource:I},{inputs:[d],outputs:[l?-1:0]})[0];l&&e.compute(De(E,c),{inputs:[E]})},Xh=(e,t)=>{wd(e.inputs),$d(e,t)},Yh=e=>ge({axis:e.axis})}),ta,bd,vd,xd,Jh,Xy=q(()=>{"use strict";te(),se(),ue(),ta=e=>Array.from(e.getBigInt64Array(),Number),bd=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==10&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, float16, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(ta(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},vd=(e,t)=>{let i=[];for(let r=0;r<e.length;++r)i.push(e[r]*t[r]);return i},xd=(e,t)=>{let i=e[0].dims,r=t??ta(e[1]),n=vd(i,r),o=O.size(n),s=e[0].dataType,l=N("input",s,i.length),d=K("output",s,n.length),c=g=>`
